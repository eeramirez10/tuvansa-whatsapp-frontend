...
export const NavBar = () => {
  ...
  const title =
    typeof titleHandle.title === 'function'
      ...
      : titleHandle.title ?? '—'
  return (
    <div className='app-topbar flex items-center justify-between h-16   bg-white border-b border-gray-200  w-full top-0'>
...
const SideBarButton: FC<Props> = ({ handleOpen }) => {
  return (
    <button
      onClick={() => handleOpen()}
      className='inline-flex ml-4 items-center p-2 mt-2 ms-3 text-sm text-gray-800 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600'
    >
