...
const apiStore: StateCreator<QuotesState> = (set, get) => ({
  ...
  createQuote: (partial) => {
    ...
    const quote: Quote = {
      ...
      quoteMeta: {
        pdfSentAt: partial?.quoteMeta?.pdfSentAt || null,
        quoteCreatedAt: partial?.quoteMeta?.quoteCreatedAt ?? null,
        versionCreatedAt: partial?.quoteMeta?.versionCreatedAt ?? null,
        createdByUser: partial?.quoteMeta?.createdByUser || null
      }
    }
